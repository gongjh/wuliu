...
<head>
    <meta charset="UTF-8">
    <title><?php echo ((isset($meta_title) && ($meta_title !== ""))?($meta_title):'物流管理系统'); ?></title>
...
<body class="index-body">
            ...
            <div class="columns-mod">
                ...
                <div class="bd">
                    <div class="sys-info">
                        <table>
                            <tr>
                                <th><a href="<?php echo U('Sendonline/add');?>">添加货物信息</a></th>
                                <td>
                                    <a href="<?php echo U('Sendonline/index');?>" >
                                        即时货物列表
                                    </a>						</td>
                            </tr>
                            <tr>
                                <th><a href="<?php echo U('Sendover/index');?>">已取货货物信息</a></th>
                                <td><a href="<?php echo U('Return_goods/index');?>">遣返货物信息</a></td>
                            </tr>
                            <tr>
                                <th><a href="<?php echo U('statistics/index');?>">统计信息</a></th>
                                <td><a href="#">新增物流公司</a></td>
                            </tr>
                        </table>
                    </div>
                </div>
    ...
    <!-- 底部版权 -->
    <div class="cont-ft">
        <div class="copyright"> ©2013 <a href="http://www.megasound.cn">megasound.cn</a> 北京大音青春广告传媒有限公司</div>
    </div>
